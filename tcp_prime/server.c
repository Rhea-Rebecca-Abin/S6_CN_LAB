...
Number send from server : 2user@user-HP-Pavilion-Laptop-14-dv0xxx:~/NETWORK LAB/SOCKET PROGRAMS/TCP_PRIME$ gcc server.c
user@user-HP-Pavilion-Laptop-14-dv0xxx:~/NETWORK LAB/SOCKET PROGRAMS/TCP_PRIME$ ./a.out
Enter the port number 4000
